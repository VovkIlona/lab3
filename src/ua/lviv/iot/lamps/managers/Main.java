...
public class Main {
	public static void main(String[] args) {
        ...
        lamps.add(new Lamps(100, 150, Currency.EUR, LightSourceType.ENERGYSAVING, true, Rating.AVERAGE));
        lamps.add(new Lamps(550, 90, Currency.UAH, LightSourceType.INCANDESCENCE, true, Rating.EXCELLENT));
        lamps.add(new Lamps(1350, 110, Currency.UAH, LightSourceType.ENERGYSAVING, true, Rating.EXCELLENT));
